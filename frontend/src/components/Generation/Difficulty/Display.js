...
function SingleSilhoutte({ num, cry, shape, random }) {
  ...
  return (
    <div
      className=' active:scale-110 relative w-[200px] h-[200px] flex justify-center items-center cursor-pointer transition-transform ease-linear duration-100 overflow-hidden'
      onClick={PokemonCry}>
      ...
      {shape && (
        <img
          src={Examples[num]}
          alt={Examples[num]}
          className='brightness-0 w-[150px] h-[150px] object-contain'
        />
      )}
